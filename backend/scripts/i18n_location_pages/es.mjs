...
<p>Podemos entregar casi a cualquier hora — las entregas por la tarde-noche o de madrugada fuera del horario habitual tienen un coste adicional y deben acordarse con antelación.</p>`,
    ...
    airport: {
        ...
        "deliveryHtml": "<ul>\n<li>Entrega gratis en alquileres de <strong>7 días o más (1 semana)</strong>.</li>\n<li>Alquileres más cortos: tarifa fija de entrega de <strong>Rp 150.000</strong>.</li>\n<li>La hora exacta y el punto de encuentro se confirman por WhatsApp tras la reserva.</li>\n</ul>\n<p>Podemos entregar casi a cualquier hora — las entregas por la tarde-noche o de madrugada fuera del horario habitual tienen un coste adicional y deben acordarse con antelación.</p>\n<p>Por favor, calcula de forma realista cuánto tardarás en salir de la terminal, teniendo en cuenta la recogida de equipaje, el control de pasaportes y la aduana. Así nuestro conductor no tendrá que esperarte demasiado.</p>\n<p>No esperamos justo en la salida — hay mucho movimiento y una espera larga ahí puede costarnos una multa. Te recibimos a 1–3 minutos a pie de la salida, en la zona de aparcamiento de motos.</p>\n<p><a class=\"btn-cta loc-cta-btn loc-cta-outline\" href=\"https://maps.app.goo.gl/3cmkLZEnQ1zisxPA8?g_st=atm\" target=\"_blank\" rel=\"noopener noreferrer\">Punto de encuentro en el aeropuerto</a></p>\n<div class=\"loc-see-all-row\"><p class=\"loc-see-all-note\" style=\"margin:0\">Podemos entregar cualquier moto de nuestra flota en el aeropuerto.</p><a class=\"btn-cta loc-cta-btn\" href=\"/es/bikes\">Ver todas las motos</a></div>",
        "gettingAroundHtml": null,
        "faqQ1": "¿Reciben a los pasajeros en el aeropuerto Ngurah Rai?",
        "faqA1": "Sí — te recibimos a 1–3 minutos a pie de la salida de llegadas, en la zona de aparcamiento de motos. Por favor, calcula de forma realista cuánto tardarás en salir de la terminal, teniendo en cuenta la recogida de equipaje, el control de pasaportes y la aduana. Así nuestro conductor no tendrá que esperarte demasiado.",
        ...
        "faqA4": "Depende de tus planes en Bali: un scooter para la ciudad, una ADV o Xmax para trayectos más largos, una moto de touring si van dos con equipaje. ¿Quieres algo más grande? Con gusto te sugerimos otras opciones:",
