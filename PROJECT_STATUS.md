...
реальных данных (анкета водителям не отправлена). По пути найдено и
...
не хватает анкеты водителям (Hari/Stefan/Saiban), которая ещё не отправлена,
и точных расстояний/часов пик, которых нет даже в
...
TODO):**
- Route и Distances для 8 из 9 районов — ждут анкету водителям
  (Hari/Stefan/Saiban), ещё не отправлена.
