...
ЗАВЕРШЁН** (миграции 028-031), чанк **Главное фото сбоку ЗАВЕРШЁН** (миграции
032-033, визуальный выбор hero для 75 products), чанк **Сезонный мультипликатор
цены + первая админка ЗАВЕРШЁН** (миграция 034, `/internal/pricing`, Basic
Auth). Ранее — чанк **SEO enrichment layer ПОЛНОСТЬЮ ЗАКРЫТ** (Шаг 0→3), чанк
Photos (657 фото/1971 файл, рендер), чанк Specs (family_specs). Плюс всё
предыдущее: каркас + каталог + продукт/калькулятор + заявка + контентные
страницы; двуязычный сайт RU+EN; номер заявки BR-00001).
